    ...
    <div className={styles['container']}>
      ...
      <section className={styles['container05']}>
        <div className={styles['container06']}>
          <h1
            className={` ${styles['text04']} ${projectStyles['headingOne']} `}
          >
            <span className={styles['text05']}>From nothing to something</span>
          </h1>
        ...
        <div className={styles['container07']}>
          <div className={styles['container08']}>
            ...
            <span className={` ${styles['text08']} ${projectStyles['small']} `}>
              ...
              <br></br>
              <span className={styles['text11']}>-NOAA</span>
            </span>
        ...
        <div className={styles['container12']}>
          <div className={styles['container13']}>
            <div className={styles['container14']}>
              ...
              <p className={` ${styles['text23']} ${projectStyles['lead']} `}>
                <span className={styles['text24']}>
                  Whatever your qualification is - we got you!
                </span>
              </p>
              <p className={` ${styles['text25']} ${projectStyles['body']} `}>
              ...
              <p className={styles['text27']}>Mark Jojansen</p>
              <p className={` ${styles['text28']} ${projectStyles['small']} `}>
      ...
      <section className={styles['Contaier']}>
        <div className={styles['container30']}>
          ...
          <h2
            className={` ${styles['text29']} ${projectStyles['headingTwo']} `}
          >
            <span className={styles['text30']}>Beware The Components</span>
          </h2>
          <h3
            className={` ${styles['text31']} ${projectStyles['headingTwo']} `}
          >
            <span className={styles['text32']}>How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className={styles['container32']}>
          <div className={styles['container33']}>
            ...
            <div className={styles['container35']}>
              ...
              <h1
                className={` ${styles['text35']} ${projectStyles['headingOne']} `}
              >
                Search and Discover!
              </h1>
        ...
        <div className={styles['container37']}>
          ...
          <div className={styles['container39']}>
            ...
            <div className={styles['container41']}>
              ...
              <h1
                className={` ${styles['text39']} ${projectStyles['headingOne']} `}
              >
                Talk and Meet!
              </h1>
